...
- [X] Stockage des paramètres dans le dossier personnel de l'utilisateur au format JSON
- [X] Stockage de l'état de l'application dans le dossier personnel de l'utilisateur au format JSON
...
- [X] Endpoints pour récupérer et mettre à jour les données de l'application
...
- [X] Héberger le serveur gratuitement
- [X] Cross-compiler la CLI pour Windows, Linux et MacOS
- [X] Publier la CLI sur GitHub dans la section Releases du dépôt
